...
pipe_best_gbr = Pipeline([
    ('std_scaler', StandardScaler()),
    ('gbr', GradientBoostingRegressor(random_state=2, n_estimators=850, learning_rate=0.03, max_depth=4, max_features=0.5, min_samples_leaf=45, loss='huber', alpha=0.95, ))
])
